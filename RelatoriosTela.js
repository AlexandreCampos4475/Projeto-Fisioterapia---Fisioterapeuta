...
const inputFields = [
  ...
  {
    placeholder: "Marcar Agendamento: dd/mm/aa - hh:mm",
...
const RelatoriosTela = ({ navigation }) => {
      ...
      <TouchableOpacity style={styles.alunoResponsavel} onPress={toggleAlunos}>
        <Text style={styles.alunoResponsavelText}>
          {alunoSelecionado !== null
            ? students[alunoSelecionado].nome
            : "Aluno Responsável"}
        </Text>
        <Image
          source={arrowDown}
          style={[styles.arrowIcon, alunosVisible ? styles.arrowIconUp : null]}
        />
      </TouchableOpacity>
        ...
        <View style={styles.alunosList}>
          {students.map((aluno, index) => (
            <TouchableOpacity
              ...
              style={[
                styles.alunoItem,
                alunoSelecionado === index ? styles.alunoSelecionado : null,
              ]}
